...
function init_threeScene(spec) {
  ...
  const r = JeelizThreeGlassesCreator({
    ...
    frameMeshURL: "glassesFramesBranchesBent.json",
    // frameMeshURL: "/glasses/scene.gltf",
    lensesMeshURL: "glassesLenses.json",
    occluderURL: "face.json"
  });
  // // CREATE THE GLASSES AND ADD THEM
  // const r = JeelizThreeGlassesCreator({
  //   envMapURL: "envMap.jpg",
...
function init_faceFilter(videoSettings){
  JEEFACEFILTERAPI.init({
    followZRot: true,
    canvasId: 'jeeFaceFilterCanvas',
    NNCPath: '', // path of NN_DEFAULT.json file
    maxFacesDetected: 1,
