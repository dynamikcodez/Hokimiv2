...
var HeadControls = (function(){
  const _defaultSettings = {
    ...
    tol: {
      rx: 9.9,// do not move if head turn more than this value (in degrees) from head rest position
      ry: 9.9,
      s: 9.9 // do not move forward/backward if head is larger/smaller than this percent from the rest position
    },
    sensibility: {
      rx: 1,
      ry: 1,
